struct CalvanoParams
    ...
    function CalvanoParams(α::Float, β::Float, δ::Float, n_players::Int, memory_length::Int, price_options::Vector{Float64}, max_iter::Int, convergence_threshold::Int)
        ...
        calvano_init_matrix = zeros(n_prices, n_prices)
        new(α, β, δ, n_players, memory_length, price_options, max_iter, convergence_threshold, n_prices, price_index, convergence_check, calvano_init_matrix)
    end
end
