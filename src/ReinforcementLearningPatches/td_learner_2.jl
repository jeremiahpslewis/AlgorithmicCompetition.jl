...
abstract type AbstractTDLearner <: AbstractLearner end

struct TDLearnerSARS{Ap,F<:AbstractFloat,I<:Integer} <: AbstractTDLearner
    approximator::Ap
    γ::F 
    n::I
end

RLCore.estimate_reward(L::T, env::E) where {T<:AbstractTDLearner,E<:AbstractEnv} = RLCore.estimate_reward(L.approximator, state(env))
RLCore.estimate_reward(L::T, s::I1) where {T<:AbstractTDLearner,I1<:Integer} = RLCore.estimate_reward(L.approximator, s)
RLCore.estimate_reward(L::T, s::I1, a::I2) where {T<:AbstractTDLearner,I1<:Integer,I2<:Integer} = RLCore.estimate_reward(L.approximator, s, a)

## update policies

# function RLBase.update!(
#     p::QBasedPolicy{<:AbstractTDLearner},
#     t::Any,
#     e::AbstractEnv,
#     s::AbstractStage,
# )
