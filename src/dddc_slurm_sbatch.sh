...
#SBATCH --array=1-500 # Number of iterations over all parameter sets
#SBATCH --mem-per-cpu=1600M
#SBATCH --cpus-per-task=128
#SBATCH --time=5:00:00 # For full run true value should be <2 hours
#SBATCH -p normal
#SBATCH --mail-user=irddcc1@mail.uni-paderborn.de   # Where to send mail	

# For full version, N_GRID_INCREMENTS=100
export N_GRID_INCREMENTS=100
export VERSION="2024-06-17-dddc-full-strong-weak-grid"
