...
@testset "Constructors" begin
    ...
    @test TabularVApproximator(n_state=10) isa TabularApproximator{1, Vector{Float64}, InvDecay}
    @test TabularQApproximator(n_state = 10, n_action=10) isa TabularApproximator{2, Matrix{Float64}, InvDecay}
end
